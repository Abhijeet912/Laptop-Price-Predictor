...
if st.button('Predict Price'):
    ...
    prediction = str(int(np.exp(rf.predict(query)[0])))
    st.title("The predicted price of this configuration could be between "+str(prediction-1000)+"₹"+"to" +str(prediction+1000)+"₹")